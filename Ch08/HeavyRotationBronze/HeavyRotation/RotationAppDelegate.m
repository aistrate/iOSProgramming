...
{
    // No way to test this on the simulator
    NSLog(@"proximityStateChanged: %d", [[note object] proximityState]);
    
    self.window.rootViewController.view.backgroundColor = [UIColor darkGrayColor];
}
